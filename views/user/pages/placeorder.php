...
<body>
    ...
    <main class="main-content">
        <form action="" class="main-wrapper" method="get">
            ...
            <div class="cart-catalog">
                <div class="form-group-cart">
                    <div class="cart-input">
                        ...
                        <input type="text" id="first-name" class="char-field" disabled />
                    </div>
                    <div class="cart-input">
                        <label>Last Name</label>
                        <input type="text" id="last-name" class="char-field" disabled />
                    </div>
                    <div class="cart-input">
                        <label>Full Address</label>
                        <input type="text" id="recipent-address" class="char-field" disabled />
                    </div>
                    <div class="cart-input">
                        ...
                        <div class="cart-input space-top">
                            ...
                            <input type="number" id="latitude" class="char-field" min="-90" max="90" step="any" disabled>
                        </div>
                        <div class="cart-input">
